...
public class AppsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (btnClick == R.id.btnSetAlarm) {
            ...
            Intent i = new Intent(AlarmClock.ACTION_SET_ALARM).putExtra(AlarmClock.EXTRA_MESSAGE, message)
...
//          Intent i = new Intent(Intent.ACTION_CALL); // Actually makes the call (DOnt forget to add the permission in the manifest to place a call.)
            ...
            intent.putExtra("IntData", 12309894);
